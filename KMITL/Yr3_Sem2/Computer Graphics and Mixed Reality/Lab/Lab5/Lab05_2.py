...
initialise()# Initialize scaling and rotation values
scale = 1.0
rotation = [0, 0, 0]
position = [0, 0, 0]
camera_height = 0.0  # Initial camera height
...
while not done:
    ...
    glPushMatrix()
    gluLookAt(0, camera_height, 5, 0, 0, 0, 0, 1, 0)
