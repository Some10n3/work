...
class Student(persistent.Persistent):
    ...
    def __str__(self):
        ...
        for enroll in self.enrolls:
            gpa += enroll.getScore() * enroll.getCourse().getCredit()
            credits += enroll.getCourse().getCredit()
            returnn += "ID : " + enroll.getCourse().getID() + " Course : " + enroll.getCourse().getName() + " Credit : " + str(enroll.getCourse().getCredit()) + " Grade : " + str(enroll.getGrade()) + "\n"
            # print("ID : " + enroll.getCourse().getID() + " Course : " + enroll.getCourse().getName() + " Credit" + str(enroll.getCourse().getCredit()) + " Grade : " + str(enroll.getGrade()))
        gpa /= credits
