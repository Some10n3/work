...
def initialize_database():
    ...
    storage = ZODB.FileStorage.FileStorage('D:\Main\Work\KMITL\Yr2_Sem1\WebProgramming\hw\hw11\mydata\mydata.fs')
    db = ZODB.DB(storage)
    connection = db.open()
    ...
    if 'students' not in root:
        ...
        root['students'][1101].enrollCourse(root['courses'][101], 80)
        root['students'][1101].enrollCourse(root['courses'][201], 92)
        root['students'][1101].enrollCourse(root['courses'][301], 78)

        root['students'][1102] = Student(1102, "Zhong")
        root['students'][1102].enrollCourse(root['courses'][101], 91)
        root['students'][1102].enrollCourse(root['courses'][201], 90)
        root['students'][1102].enrollCourse(root['courses'][202], 87)

        root['students'][1103] = Student(1103, "Dvalinn")
        root['students'][1103].enrollCourse(root['courses'][101], 72)
        root['students'][1103].enrollCourse(root['courses'][201], 73)
        root['students'][1103].enrollCourse(root['courses'][202], 70)
