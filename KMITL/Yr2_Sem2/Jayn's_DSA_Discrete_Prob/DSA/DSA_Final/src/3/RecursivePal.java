...
public class RecursivePal<T> {
    ...
    public static void main(String[] args) {
        Integer[] a0 = {1, 1, 5, 1, 1}; //recursive palindrome
        Integer[] a1 = {7, 8, 7, 7, 8, 7}; //recursive palindrome
        Integer[] a2 = {2, 0, 4, 0, 2}; //not recursive palindrome
        Integer[] a3 = {7, 4, 5, 5, 4, 7, 9, 7, 4, 5, 5, 4, 7}; //not recursive palindrome
